  ...
  <div class="wrapper">
    ...
    <div class="signup-card">
      ...
      if (isset($_SESSION['error_message'])) {
          echo '<div class="general-error" style="display: block; color: #ff4444; margin-bottom: 15px; padding: 10px; background: rgba(255,68,68,0.1); border-radius: 5px;">' . htmlspecialchars($_SESSION['error_message']) . '</div>';
          unset($_SESSION['error_message']);
      } else {
          echo '<div id="generalError" class="general-error" style="display: none;"></div>';
      }
      ?>
