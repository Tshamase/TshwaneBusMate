<?php
//php for name customization within login-homepage
session_start();
  ...
  <style>
    ...
    * {
    ...
    .header-bar {
        ...
        padding: 10px 20px;
        color: white;
        background: linear-gradient(135deg, #000, #0d1b24); /* Dark header gradient */
    ...
    /* Section styling inside main container */
    ...
    /* Show dropdown content when checked */
